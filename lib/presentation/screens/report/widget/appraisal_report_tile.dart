...
class AppraisalReportTile extends StatelessWidget {
  final AppraisalCertificateEmailReport report;
  const AppraisalReportTile({super.key, required this.report});
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                      onPressed: () async{
                        final url = Uri.parse('${ApiConstant.demoBaseUrl}/show-pdf-certificate.php?type=appraisal&id=${report.id}');
