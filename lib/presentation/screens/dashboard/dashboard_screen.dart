        ...
        bottomNavigationBar: CurvedNavigationBar(
          items: _navItems.asMap().entries.map((entry) {
            ...
            return CurvedNavigationBarItem(
              child: Image.asset(item["icon"], width: AppDimens.spacing22, height: AppDimens.spacing22, color: AppColor.primary),
              label: index == i ? '' : item["label"],
              labelStyle: TextStyle(fontSize: AppDimens.textSize12, color: AppColor.primary),
            );
          }).toList(),
