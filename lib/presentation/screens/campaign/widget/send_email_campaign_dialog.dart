...
class SendEmailCampaignDialog extends StatefulWidget {
  final String title, from;
  final Function(Map<String, dynamic>) onSend;

  const SendEmailCampaignDialog({
    super.key,
    this.title = 'Send Email To Client' ,
    required this.from ,
    required this.onSend,
  });

  @override
  State<SendEmailCampaignDialog> createState() => _SendEmailCampaignDialogState();
}

class _SendEmailCampaignDialogState extends State<SendEmailCampaignDialog> {
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                // _buildField("From", fromController, null, enable: false),
                // 7.h,
                ...
                _buildField("Message", messageController, messageFocus, maxline: 10),
                7.h,
              ],
            ),
          ),
            ...
            builder: (context, state) {
              ...
              return CustomButton(
                ...
                onPressed: () {
                  ...
                  if (titleController.text.isEmpty || subjectController.text.isEmpty || messageController.text.isEmpty) {
